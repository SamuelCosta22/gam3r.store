...
export function ProdutoItem(props: ProdutoItemProps){
    ...
    return(
        <Link href={`/produto/${props.produto.id}`} className="flex flex-col bg-violet-dark text-violet-dark-foreground border border-white/10 rounded-xl relative max-w-[350px]">
            ...
            <div className="flex flex-1 flex-col gap-3 p-5 border-t border-white/10">
                ...
                <button className="flex justify-center items-center gap-2 h-8 bg-violet-700 hover:border-2 border-emerald-500 rounded-full" onClick={(e) => {e.preventDefault()}}>
